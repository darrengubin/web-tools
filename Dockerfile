...
RUN pip install --upgrade pip setuptools wheel && \
    ...
    python -c "try: from baidusearch.baidusearch import search; print('baidusearch OK'); except: print('baidusearch not available')" && \
    python -c "try: from playwright.sync_api import sync_playwright; print('Playwright OK'); except: print('Playwright not available')"
