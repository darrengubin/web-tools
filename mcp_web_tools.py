...
def collect_auto_5_sources(date: str, weibo_cookie: Optional[str] = None) -> dict:
    ...
    sources = [
        {"name": "财联社汽车早报", "type": "search", "keyword": f"财联社 汽车早报 {cn_date}", "limit": 10, "retries": 1},
        {"name": "财联社汽车早报-站内", "type": "search", "keyword": f"site:cls.cn 汽车早报 {md_date}", "limit": 10, "retries": 1},
